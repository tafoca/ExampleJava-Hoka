...
/**
 * Main class. Starts a HTTP server and monitors its connectivity.
 */
public class Main {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		final ManageableServer slowNetworkServer = new SlowNetworkServer();
		ServerManager.startServer(slowNetworkServer);

		// Stop after 1 hour
		Thread.sleep(ONE_HOUR);

		ServerManager.stopServer(slowNetworkServer);
	}
}
