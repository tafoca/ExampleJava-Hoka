...
public class Main {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		final ManageableServer authenticationServer = new AuthenticationServer();
		ServerManager.startServer(authenticationServer);

		// Stop after 1 hour
		Thread.sleep(ONE_HOUR);

		ServerManager.stopServer(authenticationServer);
	}
}
