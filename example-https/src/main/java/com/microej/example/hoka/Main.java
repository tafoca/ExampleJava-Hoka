...
/**
 * Main class. Starts a HTTPS server and monitors its connectivity.
 */
public class Main {
	...
	public static void main(String[] args) throws InterruptedException, GeneralSecurityException, IOException {
		final ManageableServer httpsServer = new HttpsServer();
		ServerManager.startServer(httpsServer);

		// Stop after 1 hour
		Thread.sleep(ONE_HOUR);
		ServerManager.stopServer(httpsServer);
	}
}
