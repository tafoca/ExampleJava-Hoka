...
/**
 * Main class. Starts a REST server and monitors its connectivity.
 */
public class Main {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		final ManageableServer restServer = new RestServer();
		ServerManager.startServer(restServer);

		// Stop after 1 hour
		Thread.sleep(ONE_HOUR);

		ServerManager.stopServer(restServer);
	}
}
