...
/**
 * Main class. Starts a server and monitors its connectivity.
 */
public class Main {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		final ManageableServer myServer = new MyServer();
		ServerManager.startServer(myServer);

		// Stop after 1 hour
		Thread.sleep(ONE_HOUR);

		ServerManager.stopServer(myServer);
	}
}
